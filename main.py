...
odm = cv2.dnn_DetectionModel(weightsPath,configPath)
odm.setInputSize(320,320)
odm.setInputScale(1.0/ 127.5)
odm.setInputMean((127.5, 127.5, 127.5))
odm.setInputSwapRB(True)

while True:
    success,img = cap.read()
    classIds, confs, bbox = odm.detect(img,confThreshold=thres)
    bbox = list(bbox)
